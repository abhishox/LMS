...
if($con->connect_error){
	...
	echo '</tr>';
	if($row[student_issueid] > 0){
	echo '<tr><td><a style="color: blue; text-decoration:none;" href="return.php?student_id='.$row["student_ID"].'">RETURN</a></td></tr>';
	}else
	{
	echo '<tr><td>No book to return</td></tr>';
	}
	echo '</table>';
	echo '</div></a><br>';
